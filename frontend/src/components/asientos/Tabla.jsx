          ...
          {asientos.map((asiento) => {
            ...
            return (
              <>
                <tr
                  key={asiento.id}
                  className="cursor-pointer hover:bg-base-200 transition-colors duration-300 font-normal "
                ...
                >
                  ...
                  <td className="p-2 w-[20rem]">{asiento.descripcion}</td>
                  <td className="p-2">
                  ...
                  <td className="p-2  font-mono">
                    <span className="">${totalDebe.toFixed(2)}</span>
                  </td>
                  <td className="p-2 font-mono">
